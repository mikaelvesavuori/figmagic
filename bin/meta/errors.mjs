...
export const errorProcessElementsNoMainElement = `${colors.FgRed}Missing required "MAIN_ELEMENT" in processElements()!`;
export const errorProcessElementsNoTextElement = `${colors.FgRed}Missing required "TEXT_ELEMENT" in processElements()!`;
