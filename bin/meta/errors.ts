...
export const errorSetupOpacitiesTokensMissingProps: string = `${colors.FgRed}Missing "name" or "characters" properties in opacities frame!`;
export const errorSetupOpacitiesTokensNoChildren: string = `${colors.FgRed}Opacities frame has no children!`;
export const errorSetupOpacitiesTokensNoFrame: string = `${colors.FgRed}No frame for setupOpacitiesTokens()!`;
