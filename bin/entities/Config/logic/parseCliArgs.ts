...
export function parseCliArgs(argsArray: string[]): Config {
  ...
  const setConfigValue = <ValueType = unknown>(
    key: keyof Config,
    value: ValueType,
  ): void => {
    config[key] = value;
  };
  const setConfigChildValue = (
    key: keyof Config,
    childKey: string,
    value: unknown,
  ): void => {
  ...
  const cliArguments: CliArguments = {
    ...
    '--borderWidthUnit': (val: string) =>
      setConfigValue('borderWidthUnit', val.toLowerCase()),
    '-bwu': (val: string) =>
      setConfigValue('borderWidthUnit', val.toLowerCase()),
    '--radiusUnit': (val: string) =>
      setConfigValue('radiusUnit', val.toLowerCase()),
    '-ru': (val: string) => setConfigValue('radiusUnit', val.toLowerCase()),
    '--shadowUnit': (val: string) =>
      setConfigValue('shadowUnit', val.toLowerCase()),
    '-su': (val: string) => setConfigValue('shadowUnit', val.toLowerCase()),
    '--fontUnit': (val: string) =>
      setConfigValue('fontUnit', val.toLowerCase()),
    '-fu': (val: string) => setConfigValue('fontUnit', val.toLowerCase()),
    '--letterSpacingUnit': (val: string) =>
      setConfigValue('letterSpacingUnit', val.toLowerCase()),
    '-lsu': (val: string) =>
      setConfigValue('letterSpacingUnit', val.toLowerCase()),
    '--lineHeightUnit': (val: string) =>
      setConfigValue('lineHeightUnit', val.toLowerCase()),
    '-lhu': (val: string) =>
      setConfigValue('lineHeightUnit', val.toLowerCase()),
    '--opacitiesUnit': (val: string) =>
      setConfigValue('opacitiesUnit', val.toLowerCase()),
    '-ou': (val: string) => setConfigValue('opacitiesUnit', val.toLowerCase()),
    '--durationUnit': (val: string) =>
      setConfigValue('durationUnit', val.toLowerCase()),
    ...
    '--outputFolderElements': (val: string) =>
      setConfigValue('outputFolderElements', val),
    '-elements': (val: string) => setConfigValue('outputFolderElements', val),
    '--outputFolderGraphics': (val: string) =>
      setConfigValue('outputFolderGraphics', val),
    '-graphics': (val: string) => setConfigValue('outputFolderGraphics', val),
    '--outputFolderTokens': (val: string) =>
      setConfigValue('outputFolderTokens', val),
    ...
    '-fcol': (val: string) =>
      setConfigValue('outputFormatColors', val.toLowerCase()),
    '--outputFormatCss': (val: string) =>
      setConfigValue('outputFormatCss', val.toLowerCase()),
    '-fc': (val: string) =>
      setConfigValue('outputFormatCss', val.toLowerCase()),
    ...
    '--forceUpdate': () =>
      setConfigChildValue('skipFileGeneration', 'forceUpdate', true),
    '-force': () =>
      setConfigChildValue('skipFileGeneration', 'forceUpdate', true),
    '--skipCss': () =>
      setConfigChildValue('skipFileGeneration', 'skipCss', true),
    '-nocss': () => setConfigChildValue('skipFileGeneration', 'skipCss', true),
    '--skipDescription': () =>
      setConfigChildValue('skipFileGeneration', 'skipDescription', true),
    '-nodesc': () =>
      setConfigChildValue('skipFileGeneration', 'skipDescription', true),
    '--skipReact': () =>
      setConfigChildValue('skipFileGeneration', 'skipReact', true),
    '-noreact': () =>
      setConfigChildValue('skipFileGeneration', 'skipReact', true),
    '--skipStorybook': () =>
      setConfigChildValue('skipFileGeneration', 'skipStorybook', true),
    '-nostory': () =>
      setConfigChildValue('skipFileGeneration', 'skipStorybook', true),
    '--skipStyled': () =>
      setConfigChildValue('skipFileGeneration', 'skipStyled', true),
    '-nostyled': () =>
      setConfigChildValue('skipFileGeneration', 'skipStyled', true),
    '--spacingUnit': (val: string) =>
      setConfigValue('spacingUnit', val.toLowerCase()),
