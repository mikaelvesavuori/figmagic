...
function getElementType(element): string {
  let elementType = 'div';
...
function getDescription(element): string {
...
async function handleNonNestedElements(element): Promise<object> {
...
async function handleNestedElements(element): Promise<string> {
  await Promise.all(
