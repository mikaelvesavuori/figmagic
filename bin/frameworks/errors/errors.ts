...
export const ErrorCleanSvgData = ErrorMessage(
...
export const ErrorCreateElements = ErrorMessage(
...
export const ErrorCreateFolder = ErrorMessage(
...
export const ErrorCreateGraphics = ErrorMessage(
...
export const ErrorCreatePage = ErrorMessage(
  'No pages provided to createPage()!',
);
export const ErrorCreateSolidColorString = ErrorMessage(
...
export const ErrorExtractDescription = ErrorMessage(
  'Missing description in extractDescription()!',
);
export const ErrorExtractTokens = ErrorMessage(
  'No sheet or name for processTokens()!',
);
export const ErrorExtractTokensNoConfig = ErrorMessage(
  'No config provided to processTokens()!',
);
export const ErrorFigmagicController = ErrorMessage(
...
export const ErrorGetDataLocal = ErrorMessage(
...
export const ErrorGetDescription = ErrorMessage(
...
export const ErrorGetFileContents = ErrorMessage(
...
export const ErrorGetIds = ErrorMessage(
...
export const ErrorGetPaddingX = ErrorMessage(
  'Error when calling getPaddingX()!',
);
export const ErrorGetPaddingY = ErrorMessage(
...
export const ErrorGetSvgFileData = ErrorMessage(
...
export const ErrorHandleNestedElements = ErrorMessage(
...
export const ErrorGetBackgroundColor = ErrorMessage(
...
export const ErrorMakeBorderWidthTokensNoChildren = ErrorMessage(
...
export const ErrorMakeColorTokensNoChildren = ErrorMessage(
  'Color tokens frame has no children!',
);
export const ErrorMakeColorTokensNoFrame = ErrorMessage(
...
export const ErrorMakeDelayTokensNoChildren = ErrorMessage(
  'Delay frame has no children!',
);
export const ErrorMakeDelayTokensNoFrame = ErrorMessage(
...
export const ErrorMakeDurationTokensNoChildren = ErrorMessage(
  'Duration frame has no children!',
);
export const ErrorMakeDurationTokensNoFrame = ErrorMessage(
...
export const ErrorMakeEasingTokensNoChildren = ErrorMessage(
  'Easing frame has no children!',
);
export const ErrorMakeEasingTokensNoFrame = ErrorMessage(
...
export const ErrorMakeFontSizeTokensNoFrame = ErrorMessage(
...
export const ErrorMakeFontTokensNoFrame = ErrorMessage(
...
export const ErrorMakeLineHeightTokensNoName = ErrorMessage(
...
export const ErrorMakeOpacityTokensNoChildren = ErrorMessage(
  'Opacities frame has no children!',
);
export const ErrorMakeOpacityTokensNoFrame = ErrorMessage(
...
export const ErrorMakeRadiusTokensNoChildren = ErrorMessage(
  'Radius frame has no children!',
);
export const ErrorMakeRadiusTokensNoFrame = ErrorMessage(
...
export const ErrorMakeShadowTokensNoChildren = ErrorMessage(
  'Shadow frame has no children!',
);
export const ErrorMakeShadowTokensNoFrame = ErrorMessage(
...
export const ErrorMakeSpacingTokensNoChildren = ErrorMessage(
  'Spacing frame has no children!',
);
export const ErrorMakeSpacingTokensNoFrame = ErrorMessage(
...
export const ErrorMakeZindexTokensNoChildren = ErrorMessage(
  'Z Index frame has no children!',
);
export const ErrorMakeZindexTokensNoFrame = ErrorMessage(
  'No frame for makeZindexTokens()!',
);
export const ErrorNormalizeUnits = ErrorMessage(
...
export const ErrorParseBackgroundColor = ErrorMessage(
  'Error in parseBackgroundColor()!',
);
export const ErrorParseBorderColor = ErrorMessage(
  'Error in parseBorderColor()!',
);
export const ErrorParseBorderRadius = ErrorMessage(
  'Error in parseBorderRadius()!',
);
export const ErrorParseBorderWidth = ErrorMessage(
  'Error in parseBorderWidth()!',
);
export const ErrorParseCliArgs = ErrorMessage(
...
export const ErrorProcessGraphicsNoImages = ErrorMessage(
...
export const ErrorSanitizeString = ErrorMessage(
...
export const ErrorSliceOutObjectFromFile = ErrorMessage(
...
export const ErrorValidateConfig = ErrorMessage(
...
export const ErrorWriteBaseJson = ErrorMessage(
...
export const ErrorWriteFileWrongType = ErrorMessage(
