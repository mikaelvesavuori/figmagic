...
export const ErrorGetFontColor = `${colors.FgRed}Error in getFontColor()!`;
export const ErrorGetFiles = `${colors.FgRed}Error in getFiles()!`;
export const ErrorGetFileContents = `${colors.FgRed}Missing path, name and/or format!`;
...
export const ErrorGetPaddingX = `${colors.FgRed}Error when calling getPaddingX()!`;
export const ErrorGetPaddingY = `${colors.FgRed}Error when calling getPaddingY()!`;
...
export const ErrorParseCssFromElement = `${colors.FgRed}Missing one or more of required arguments: "layoutElement", "textElement", "remSize", and/or "outputTokenFormat" when calling parseCssFromElement()!`;
...
export const ErrorParseHeight = `${colors.FgRed}Error in parseHeight()!`;
export const ErrorParsePadding = `${colors.FgRed}Error in parsePadding()!`;
export const ErrorGetBackgroundColor = `${colors.FgRed}Error in getBackgroundColor()!`;
export const ErrorParseBackgroundColor = `${colors.FgRed}Error in parseBackgroundColor()!`;
export const ErrorParseBorderWidth = `${colors.FgRed}Error in parseBorderWidth()!`;
export const ErrorGetBorderColor = `${colors.FgRed}Error in getBorderColor()!`;
export const ErrorParseBorderColor = `${colors.FgRed}Error in parseBorderColor()!`;
export const ErrorParseBorderRadius = `${colors.FgRed}Error in parseBorderRadius()!`;
export const ErrorGetShadow = `${colors.FgRed}Error in getShadow()!`;
export const ErrorParseShadow = `${colors.FgRed}Error in parseShadow()!`;
export const ErrorUpdateParsing = `${colors.FgRed}Error in updateParsing()!`;
...
export const ErrorSliceOutObjectFromFile = `${colors.FgRed}Error in sliceOutObjectFromFile()!`;
