...
- `specs/graphics` will contain generated graphics for your components (you will need to add the parameter `-- graphics` to the call to getImages and downloadImages)
