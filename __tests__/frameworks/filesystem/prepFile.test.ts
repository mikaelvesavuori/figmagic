...
export default AaaStyled;`;
    ...
    const expectedData = {
      fileContent: fileContent,
      filePath: 'ComponentNameStyled.jsx',
    };

    expect(prepStyledComponents(data as PrepStyledComponents)).toMatchObject(
      expectedData,
    );
  });
...
export const ComponentNameRegular = () => <ComponentName>Something here</ComponentName>;`;
    ...
    const expectedData = {
      fileContent: fileContent,
      filePath: 'ComponentName.stories.js',
    };
...
Description here.`;
    ...
    const expectedData = {
      fileContent: fileContent,
      filePath: 'ComponentName.description.md',
    };

    expect(prepDescription(data as PrepDescription)).toMatchObject(
      expectedData,
    );
  });
...
export default aaa;`;
    ...
    expect(prepGraphicComponent(data as PrepGraphicComponent)).toMatchObject(
      expectedData,
    );
  });
});
