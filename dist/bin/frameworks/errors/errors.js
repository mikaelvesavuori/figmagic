...
exports.ErrorPrepareWrite = ErrorMessage('No templates provided to prepareWrite()! Seems like fallback template path also failed...');
...
exports.ErrorValidateConfigTemplatePathReact = ErrorMessage('Argument "templatePathReact" should include valid file format suffix (e.g. jsx), but does not!.');
exports.ErrorValidateConfigTemplatePathStorybook = ErrorMessage('Argument "templatePathStorybook" should include valid file format suffix (e.g. js), but does not!');
exports.ErrorValidateConfigTemplatePathStyled = ErrorMessage('Argument "templatePathStyled" should include valid file format suffix (e.g. jsx), but does not!');
