...
function Message(str, warn) {
  if (warn) return `${colors_1.colors.FgYellow}${str}${colors_1.colors.Reset}`;
  else return `${colors_1.colors.FgGreen}${str}${colors_1.colors.Reset}`;
}
...
exports.MsgConfigDebugFinal = Message(
...
exports.MsgGeneratedFileWarning = Message(
...
exports.MsgGetTokenMatchNoMatch = Message(
...
exports.MsgProcessElementsCreatingElement = (elementName, fixedName) =>
